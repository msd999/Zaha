              ...
              onPressed: () {
                Navigator.of(context).push(
                  new MaterialPageRoute(
                    ...
                    new SpecializationTips(categoryId: widget.i, categoryTitle: widget.title,),
                  ),
                );
              },
              child: Text(
                ' نصائح حول ' + widget.title.toString(),
                style: TextStyle(
                  fontSize: 14.0,
                  fontFamily: "CustomIcons",
                ),
...
class BikeListItem extends StatelessWidget {
          ...
          return new Container(
            ...
            child: new GestureDetector(
              onTap: () {
                ...
                Navigator.of(context).push(
                  new MaterialPageRoute(
                      builder: (BuildContext context) => new CompanyDetailPagee(
                            id: list1[i]['cid'],
                            logo: list1[i]['logo'],
                            name: list1[i]['cname'],
                            typoe: list1[i]['typoe'],
                            adress: list1[i]['adress'],
                            phone: list1[i]['phone'],
                            email: list1[i]['email'],
                            whatsup: list1[i]['whatsup'],
                            details: list1[i]['details'],
                            mobilephone: list1[i]['mobilephone'],
                          )),
                );
              },
              child: Card(
  ...
  Container _buildTag(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
          borderRadius: BorderRadius.circular(20.0), color: Colors.deepOrange),
      child: Text(
        "",
        style: TextStyle(
            color: Colors.white,
