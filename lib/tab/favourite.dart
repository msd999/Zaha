              ...
              builder: (context ,snapshot){
                ...
                return snapshot.hasData
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      const ListTile(
                        leading: Icon(Icons.center_focus_strong, size: 50),
                        title: Text('المفضلة فارغة',textDirection: TextDirection.rtl,style: TextStyle(fontWeight:FontWeight.bold,fontSize: 20.0),),
                      ),
                    ],
                  ),
                );
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Text(
                        "عذراً، يجب أن تسجل دخولك حتى تتمكن من استخدام هذه الصفحة.",
                        style: TextStyle(
                          color: Colors.black,
                          fontSize: 20,
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            Text.rich(
                              ...
                              style: TextStyle(color: Colors.grey.shade700,      fontFamily: "CustomIcons",),
                            ),
                            const SizedBox(height: 5.0),
